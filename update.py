...
for file_path in files:
    ...
    if 'index.html' in file_path:
        ...
        content = content.replace('+1 (800) 774-3384', '+91 91377 73967')
        content = content.replace('tel:+18007743384', 'tel:+919137773967')
        content = content.replace('+91 70454 47189', '+91 91377 73967')
        content = content.replace('917045447189', '919137773967')

        # Add whatsapp link
        old_phone_html = '<a href="tel:+919137773967" class="contact-link" id="phoneLink">+91 91377 73967</a>'
